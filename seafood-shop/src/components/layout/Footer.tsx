      ...
      <div className="container mx-auto px-4 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-4 mb-5">
              <div className="w-16 h-16 rounded-full border-2 border-white/20 p-0.5 bg-white/10 backdrop-blur shadow-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 tracking-widest uppercase">Hải sản IQF</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-11 h-11 bg-white/5 hover:bg-blue-500 rounded-xl flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z"/>
                </svg>
              </a>
              <a href="https://zalo.me/0899630279" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/5 hover:bg-cyan-500 rounded-xl flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1" aria-label="Zalo">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h4 className="text-lg font-bold text-white mb-5 flex items-center gap-3">
              <span className="w-2 h-7 bg-gradient-to-b from-accent to-orange-400 rounded-full"></span>
              Liên kết nhanh
            </h4>
          ...
          <div>
            <h4 className="text-lg font-bold text-white mb-5 flex items-center gap-3">
              <span className="w-2 h-7 bg-gradient-to-b from-primary to-cyan-400 rounded-full"></span>
              Chính sách
            </h4>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          <div>
            <h4 className="text-lg font-bold text-white mb-5 flex items-center gap-3">
              <span className="w-2 h-7 bg-gradient-to-b from-green-400 to-emerald-500 rounded-full"></span>
              Liên hệ
            </h4>
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 group">
                <div className="w-10 h-10 bg-white/5 group-hover:bg-primary/20 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 transition-all duration-300">
              ...
              <li className="flex items-center gap-3 group">
                <div className="w-10 h-10 bg-white/5 group-hover:bg-green-500/20 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300">
                  <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <a href="tel:0899630279" className="text-gray-400 hover:text-white transition-colors font-semibold text-base">0899 630 279</a>
              </li>
              <li className="flex items-center gap-3 group">
                <div className="w-10 h-10 bg-white/5 group-hover:bg-accent/20 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300">
                  <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <a href="mailto:nghiennhi279@gmail.com" className="text-gray-400 hover:text-white transition-colors">nghiennhi279@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          ...
          <div className="flex items-center gap-3 flex-wrap justify-center">
            ...
            <span className="text-gray-700">|</span>
            <a href="mailto:vominhtan.contact@gmail.com" className="hover:text-white transition-colors">vominhtan.contact@gmail.com</a>
          </div>
        </div>
      </div>
    </footer>
